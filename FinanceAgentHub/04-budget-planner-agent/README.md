# Budget Planner Agent (04-budget-planner-agent)

> Part of the **FinanceAgentHub** Distributed Multi-Agent AI System.

## Overview
Creates monthly 50/30/20 category budget allocations, spending limits, and recommendations.

## Network Ports
- **Frontend Vite Client**: `http://localhost:3003`
- **Backend Express Server**: `http://localhost:5003`
