# Smart Savings Advisor Agent (03-smart-savings-advisor-agent)

> Part of the **FinanceAgentHub** Distributed Multi-Agent AI System.

## Overview
Generates personalized savings strategies, estimated savings metrics, and financial warnings.

## Network Ports
- **Frontend Vite Client**: `http://localhost:3002`
- **Backend Express Server**: `http://localhost:5002`
